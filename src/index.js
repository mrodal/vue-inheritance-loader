...
const loader = function (source, map) {
  ...
  getMergedCode(source, this.context, null, this).then(result => {
...
const getMergedCode = function (source, basePath, aliases, context) {
  return new Promise((resolve, reject) => {
    resolveComponent(source, basePath, aliases, context).then(({source, ancestorsPaths}) => {
      ...
      if (currentDesc.template && currentDesc.template.attrs[options.EXTENDS_ATTR]) {
        ...
        let processComponent = (baseAbsPath) => {
          fs.readFile(baseAbsPath, 'utf8', (err, contents) => {
            ...
            resolveComponent(contents, basePath, aliases, context).then(({source, ancestorsPaths}) => {
              try {
